  ...
  const promise = fetch(
    ...
    products = productsData.map((product) => {
      if (product.type === "clothing") {
        return new clothing(product.id, product.image, product.name, product.rating, product.priceCents, product.sizeChartLink);
      };
      return new Product(product.id, product.image, product.name, product.rating, product.priceCents);
    });
